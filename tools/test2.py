...
from lib.core.function import validate, validate_lane_det
...
def main():
    ...
    valid_loader = DataLoaderX(
        ...
        pin_memory=False,
        collate_fn=dataset.LaneDetDataset.collate_fn
    )

    print('load data finished')

    epoch = 0 #special for test
    da_segment_results,ll_segment_results,detect_results, total_loss,maps, times = validate_lane_det(
