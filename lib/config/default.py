...
_C.LOSS.DA_SEG_GAIN = 0.2  # driving area segmentation loss gain  default:0.2
_C.LOSS.LL_SEG_GAIN = 0.2  # lane line segmentation loss gain  default:0.2
_C.LOSS.LL_IOU_GAIN = 0.2 # lane line iou loss gain  default:0.2


# DATASET related params
_C.DATASET = CN(new_allowed=True)

_C.DATASET.DATAROOT = r'F:\dataset\bdd100k\images\100k'       # the path of images folder
_C.DATASET.LABELROOT = r'F:\dataset\bdd100k\det_gt'      # the path of det_annotations folder
_C.DATASET.MASKROOT = r'F:\dataset\bdd100k\seg_gt'                # the path of da_seg_annotations folder
_C.DATASET.LANEROOT = r'F:\dataset\bdd100k\lane_gt'               # the path of ll_seg_annotations folder

_C.DATASETVAL = CN(new_allowed=True)
_C.DATASETVAL.DATAROOT = r'F:\dataset\tusimple_lane\images1000'
_C.DATASETVAL.LABELROOT = r'F:\dataset\tusimple_lane\det_label1000'
_C.DATASETVAL.MASKROOT = r'F:\dataset\tusimple_lane\da_label1000'
_C.DATASETVAL.LANEROOT = r'F:\dataset\tusimple_lane\ll_label1000'

_C.DATASET.DATASET = 'BddDataset'
_C.DATASET.TRAIN_SET = 'train'
_C.DATASET.TEST_SET = 'val_cover'
